...
<section id="flight_requests_create">
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="content-header">Llegada de Vuelo #{{$vuelo->id}}</div>
    </div>
  </div>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-content">
          <div class="px-3 pt-3">
            <form class="form" method="POST" action="{{ route('vuelos_llegadas.store', ['id' => $vuelo->id]) }}">
            {{ csrf_field() }}
              <div class="form-body">
                ...
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <div class="position-relative">
                        <input type="text" class="form-control" value="{{datetimeformat($vuelo->salida->fecha)}}" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <div class="position-relative has-icon-left">
                        <input type="text" class="form-control" value="{{$vuelo->salida->tacometro}}" readonly>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="end_fecha">CoPiloto</label>
                      <div class="position-relative has-icon-left">
                        <?php
                        if ($vuelo->copiloto == null) {
                          $value_copiloto = 'Sin Copiloto';
                        } else {
                          $value_copiloto = fullname($vuelo->copiloto->user_id);
                        }
                        ?>
                        <input type="text" class="form-control" value="{{$value_copiloto}}" readonly>
                        <div class="form-control-position">
                          <i class="ft-user"></i>
                        </div>
                      </div>
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <div class="position-relative has-icon-left">
                        <input type="text" class="form-control" value="{{$vuelo->cobros->pasajeros}}" readonly>
                        <div class="form-control-position">
                          <i class="ft-users"></i>
                        </div>
                      </div>
                ...
                <h4 class="form-section"><i class="fas fa-plane-arrival"></i> Información sobre Llegada del Vuelo</h4>

                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="start_fecha">Pais</label>
                      <div class="position-relative">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="start_fecha">Fecha de Llegada real</label>
                      <div class="position-relative has-icon-left">
                        <input type="date" class="form-control" name="fecha" value="{{dateformatCustom($vuelo->solicitud->end,'Y-m-d')}}" required min="{{date('Y-m-d')}}">
                        <div class="form-control-position">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="start_hora">Hora de Llegada real</label>
                      <div class="position-relative has-icon-left">
                        <input type="time" class="form-control" name="hora" value="{{dateformatCustom($vuelo->solicitud->end,'H:i')}}" required>
                        <div class="form-control-position">
                          <i class="ft-clock"></i>
                        </div>
                      </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <div class="position-relative has-icon-left">
                      <input type="number" class="form-control" name="tacometro" min="{{ $vuelo->salida->tacometro }}" step="0.1" required>
                        <div class="form-control-position">
                          <i class="fas fa-tachometer-alt"></i>
                        </div>
                      </div>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" value="" name="comentarios"></textarea>
                </div>
              ...
              <div class="form-actions">
                <button type="submit" class="btn btn-raised btn-raised btn-primary">
                  <i class="fa fa-check-square-o"></i> Cerrar Vuelo
                </button>
              </div>
            </form>
          </div>
