...
<section id="flight_requests_create">
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="content-header">Aterrizaje parcial del Vuelo #{{$vuelo->id}}</div>
    </div>
  </div>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-content">
          <div class="px-3 pt-3">
            <form class="form" method="POST" action="{{ route('vuelos.bitacoras.storellegada', ['id' => $vuelo->id]) }}">
            {{ csrf_field() }}
              <div class="form-body">
                ...
                <h4 class="form-section"><i class="fas fa-plane-arrival"></i> Información sobre Aterrizaje Parcial del Vuelo</h4>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="start_fecha">Fecha de Llegada</label>
                      <div class="position-relative has-icon-left">
                        <input type="date" class="form-control" name="fecha" value="{{ date('Y-m-d') }}" required min="{{ date('Y-m-d') }}">
                        <div class="form-control-position">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="start_hora">Hora de Llegada</label>
                      <div class="position-relative has-icon-left">
              ...
              <div class="form-actions">
                <button type="submit" class="btn btn-raised btn-raised btn-primary">
                  <i class="fa fa-check-square-o"></i> Aterrizaje parcial
                </button>
              </div>
            </form>
          </div>
