...
<section id="flight_requests_create">
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="content-header">Nuevo Despegue del Vuelo #{{$vuelo->id}}</div>
    </div>
  </div>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-content">
          <div class="px-3 pt-3">
            <form class="form" method="POST" action="{{ route('vuelos.bitacoras.storesalida', ['id' => $vuelo->id]) }}">
            {{ csrf_field() }}
              <div class="form-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <div class="position-relative">
                        <select name="airport_id" id="airports" class="form-control" required>
                          <option disabled>Seleccione un Aeropuerto</option>
                        </select>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <div class="position-relative has-icon-left">
                        <input type="number" class="form-control" name="tacometro" value="{{ $vuelobitacora->tacometro }}" min="0" step="0.1" required>
                        <div class="form-control-position">
                  ...
                  <!-- Activar esta opcion solo si es permitido el cambio de pasajeros en un vuelo tipo RAID
                  <div class="col-md-3">
                    <div class="form-group">
              ...
              <div class="form-actions">
                <button type="submit" class="btn btn-raised btn-raised btn-primary">
                  <i class="fa fa-check-square-o"></i> Despegar Nuevamente
                </button>
              </div>
            </form>
          </div>
